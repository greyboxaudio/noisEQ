...
/**
*/
class noisEQAudioProcessorEditor : public juce::AudioProcessorEditor
{
public:
    noisEQAudioProcessorEditor(noisEQAudioProcessor&);
    ~noisEQAudioProcessorEditor() override;
...
private:
    ...
    juce::ToggleButton peakButtonLM;
    juce::ToggleButton peakButtonHM;
    juce::ToggleButton peakButtonH;
    juce::ToggleButton precisionButton;
    ...
    std::unique_ptr<juce::AudioProcessorValueTreeState::ButtonAttachment> peakButtonAttachmentLM;
    std::unique_ptr<juce::AudioProcessorValueTreeState::ButtonAttachment> peakButtonAttachmentHM;
    std::unique_ptr<juce::AudioProcessorValueTreeState::ButtonAttachment> peakButtonAttachmentH;
    std::unique_ptr<juce::AudioProcessorValueTreeState::ButtonAttachment> precisionButtonAttachment;
    noisEQAudioProcessor& audioProcessor;

    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(noisEQAudioProcessorEditor)
};
