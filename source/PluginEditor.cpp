...
//==============================================================================
noisEQAudioProcessorEditor::noisEQAudioProcessorEditor(noisEQAudioProcessor& p)
    : AudioProcessorEditor(&p), audioProcessor(p)
{
    ...
    peakButtonLM.setButtonText("PeakLM");
    addAndMakeVisible(peakButtonLM);
    peakButtonAttachmentLM = std::make_unique<juce::AudioProcessorValueTreeState::ButtonAttachment>(audioProcessor.apvts, "PEAK_LM", peakButtonLM);

    peakButtonHM.setButtonText("PeakHM");
    addAndMakeVisible(peakButtonHM);
    peakButtonAttachmentHM = std::make_unique<juce::AudioProcessorValueTreeState::ButtonAttachment>(audioProcessor.apvts, "PEAK_HM", peakButtonHM);
    ...
    precisionButton.setButtonText("64bit");
    addAndMakeVisible(precisionButton);
    precisionButtonAttachment = std::make_unique<juce::AudioProcessorValueTreeState::ButtonAttachment>(audioProcessor.apvts, "PRECISION", precisionButton);
...
noisEQAudioProcessorEditor::~noisEQAudioProcessorEditor()
{
}

//==============================================================================
void noisEQAudioProcessorEditor::paint(juce::Graphics& g)
{
    ...
    g.setFont(16.0f);
    g.drawFittedText (__DATE__ " " __TIME__, getLocalBounds(), juce::Justification::bottomRight, 1);
}

void noisEQAudioProcessorEditor::resized()
{
    ...
    precisionButton.setBounds(25,425,100,50);
    ...
    peakButtonHM.setBounds(600,50,100,50);
    peakButtonLM.setBounds(600,375,100,50);
}